...
function registerRoutes(app) {
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            ...
            app.get("/api/dashboard", /*isAuthenticated,*/ function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var userId, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            user = _a.sent();
                            res.json({ message: "Welcome to your dashboard", user: user });
                            return [2 /*return*/];
                    }
                });
            }); });
